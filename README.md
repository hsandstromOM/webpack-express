...
A boilerplate for running a Webpack workflow in Node express that is deployable on heroku.
...
## Install and Running
`git clone https://github.com/hsandstromOM/webpack-express.git`

or just export the files:

`svn export https://github.com/hsandstromOM/webpack-express/trunk ./dir`

1. cd webpack-express
2. npm install
3. npm start
